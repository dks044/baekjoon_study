...
public class RecursiveProfessor {
    ...
    public static void recursiveFunction(int n, int depth) {
        String line = "_".repeat(depth * 4); // 깊이에 따른 밑줄 생성
        if (n == 0) { // 재귀 종료 조건
        ...
        recursiveFunction(n - 1, depth + 1); // 깊이를 1 증가시키며 재귀 호출
        System.out.println(line + "라고 답변하였지."); // 재귀 호출이 끝난 후 출력
    }
}
